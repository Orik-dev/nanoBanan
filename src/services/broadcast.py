...
# #             log.info(f"✅ Video compressed: {original_mb:.1f}MB → {compressed_mb:.1f}MB")
# #             return out
# #         else:
# #             if out.exists():
# #                 out.unlink()
...
# #         log.error("Video compression timeout (120s)")
# #         return None
# #     except Exception as e:
# #         log.warning(f"Video compression failed: {e}")
# #         if out.exists():
# #             out.unlink()
# #         return None
...
#                     log.info(f"Using compressed video: {compressed}")
...
#                                 log.error(f"Video not found: {media_file_path}")
...
#                         log.error(f"❌ Error for {chat_id}: {e}")
#                         return "failed"
...
#             if not chat_ids:
#                 log.info(f"✅ Broadcast {job_id} complete")
#                 break
...
#                     video_path.unlink()
#                     log.info(f"🗑️ Deleted video: {video_path}")
#         except Exception as e:
...
#                 )
#             except Exception as e:
#                 log.exception(f"Failed to notify admin: {e}")
